...
<div class="w-[20%] bg-white p-4 border-r border-gray-300 ml-0">
    ...
    <ul class="space-y-2">
        <li><a href="{{ url('/report/aos') }}" class="flex items-center text-blue-500 hover:text-blue-700"><span class="mr-2">➕</span> Aircraft Operation Summary</a></li>
        <li><a href="{{ url('/report/pilot') }}" class="flex items-center text-blue-500 hover:text-blue-700"><span class="mr-2">➕</span> Pilot Report And Technical Delay</a></li>
